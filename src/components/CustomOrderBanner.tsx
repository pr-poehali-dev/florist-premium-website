  ...
  return (
    <section className="py-16 relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(47, 79, 79, 0.85), rgba(47, 79, 79, 0.85)), url(https://images.unsplash.com/photo-1557499305-bd68d0ad468d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80)`,
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="md:max-w-2xl">
          ...
          <p className="text-cream/90 text-lg mb-8">
            Расскажите нам о своих пожеланиях, и мы создадим эксклюзивную композицию, 
            которая идеально подойдет для вашего события или станет особенным подарком.
          </p>
